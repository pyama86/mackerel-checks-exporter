module github.com/pyama86/mackerel-check-plugin-exporter

go 1.12

require (
	git.pepabo.com/fukuoka-admin/ghost v0.2.0-develop-latest
	...
	github.com/juju/httprequest v2.0.0+incompatible // indirect
	github.com/juju/juju v0.0.0-20191118224923-9f6200034487
	...
	gopkg.in/juju/charm.v6 v6.0.0-20191113154506-4e6efee6340b // indirect
	gopkg.in/juju/charmrepo.v3 v3.0.1 // indirect
	gopkg.in/juju/environschema.v1 v1.0.0 // indirect
	gopkg.in/juju/names.v3 v3.0.0-20191002051627-8d2f241f8a5d // indirect
	gopkg.in/juju/worker.v1 v1.0.0-20191018043616-19a698a7150f // indirect
	gopkg.in/macaroon-bakery.v2-unstable v2.0.0-20171026135619-38b77b89a624 // indirect
	gopkg.in/macaroon.v2 v2.1.0 // indirect
	gopkg.in/macaroon.v2-unstable v2.0.0-20180319203259-5c9beabe0e9e // indirect
